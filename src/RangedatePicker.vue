<template>
  <div class="calendar-root">
    <div class="input-date" @click="toggleCalendar()"> <span v-if="dateRange.start">{{getDateString(dateRange.start)}} - {{getDateString(dateRange.end)}}</span><span v-else>{{placeholder}}</span> </div>
